...
export function AboutSection() {
  return (
    <section id="about" className="py-20 sm:py-24 border-b border-zinc-800">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white tracking-tight">About SCRO @ UCF</h2>
        ...
        <div className="mb-12 rounded-xl border border-zinc-800 bg-[#111] p-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {missionCards.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className="rounded-xl border border-zinc-800 bg-transparent p-6 hover:bg-[#111] transition-colors"
              >
